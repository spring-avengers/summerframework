...
public class LockOperation  implements ApplicationContextAware {
    ...
    public LockInstance requireLock(String name,long timeoutMillis,long expireTimeMillis,LockType type,boolean fair) {
        ...
        return requireLock(name,timeoutMillis,expireTimeMillis,type,false,defaultLockFactory);
    }

    public LockInstance requireLock(String name,long timeoutMillis,long expireTimeMillis,LockType type,boolean fair,LockFactory lockFactory) {
